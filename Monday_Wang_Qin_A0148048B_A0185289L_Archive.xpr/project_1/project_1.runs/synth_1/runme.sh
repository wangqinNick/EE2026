...
HD_PWD='C:/Users/wangh/OneDrive/Desktop/project_X.xpr/project_X5.xpr/project_XX1.xpr/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Voice_Scope_TOP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Voice_Scope_TOP.tcl
